# Generated by Django 3.2.15 on 2022-11-08 23:07
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contacts', models.ManyToManyField(editable=False, related_name='assets', to='core.Person')),
                ('department', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.department')),
                ('documents', models.ManyToManyField(editable=False, related_name='assets', to='core.Document')),
                ('manufacturer', models.ForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.manufacturer')),
                ('notes', models.ManyToManyField(editable=False, related_name='assets', to='core.Note')),
                ('pictures', models.ManyToManyField(editable=False, related_name='assets', to='core.Picture')),
                ('purchases', models.ManyToManyField(editable=False, related_name='assets', to='core.Purchase')),
                ('room', models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.room')),
                ('tags', models.ManyToManyField(editable=False, related_name='assets', to='core.Tag')),
                ('videos', models.ManyToManyField(editable=False, related_name='assets', to='core.Video')),
            ],
            options={
                'ordering': ['-id'],
            },
